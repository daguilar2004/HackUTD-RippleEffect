...
const Menu = () => {
  ...
  return (
    ...
    <div className='w-96 p-6 flex flex-col items-center bg-neutral-700 rounded-xl'>
      ...
      <img className="w-36 mb-4 rounded-full " src="https://plus.unsplash.com/premium_photo-1663061406443-48423f04e73d?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y29tbXVuaXR5JTIwc2VydmljZXxlbnwwfHwwfHx8MA%3D%3D" />
